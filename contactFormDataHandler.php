...
$name = $surname = $email = $phone = $country = $platform = '';
$platform = 0;
$nameErr = $surNameErr = $emailErr = $phoneErr = $countryErr = $platformErr = '';
$message = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  mail('spbabiak@gmail.com', 'New Contact from message from TheWandedTrader website', $message);
